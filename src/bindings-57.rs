...
pub const DATA_MAX_NAME_LEN: ::std::os::raw::c_uint = 128;
pub const OCONFIG_TYPE_STRING: ::std::os::raw::c_uint = 0;
pub const OCONFIG_TYPE_NUMBER: ::std::os::raw::c_uint = 1;
pub const OCONFIG_TYPE_BOOLEAN: ::std::os::raw::c_uint = 2;
pub const DS_TYPE_COUNTER: ::std::os::raw::c_uint = 0;
pub const DS_TYPE_GAUGE: ::std::os::raw::c_uint = 1;
pub const DS_TYPE_DERIVE: ::std::os::raw::c_uint = 2;
pub const DS_TYPE_ABSOLUTE: ::std::os::raw::c_uint = 3;
